...
public class ExRAMImpl extends JPanel implements EmulatorDisplay, ActionListener, KeyListener, BusListener, MouseWheelListener
{
	...
	public void paintComponent(Graphics g)
	{
		...
		{
			g.setColor(Color.red);
			g.fillRect(leftAlignHelper, g.getFontMetrics().getHeight() + g.getFontMetrics().getDescent(),g.getFontMetrics().getWidths()[32] * 3,  22);
			g.setColor(Color.white);
		}
		
		drawString(g, ramPageString, leftAlignHelper, 150);
